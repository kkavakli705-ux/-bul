    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          ilanlar.sort((a, b) {
            final af = a.data()['featured'] == true;
            final bf = b.data()['featured'] == true;
  ...
  Future<void> oneCikarmaTalebi(
    ...
    try {
      ...
      if (context.mounted) {
        mesaj(
          context,
          'Öne çıkarma talebi yöneticiye gönderildi.',
        );
      }
    } catch (_) {
      if (context.mounted) {
        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              subtitle: const Text(
                'Kullanıcı taleplerini onayla veya reddet',
              ),
              trailing: const Icon(
                Icons.arrow_forward_ios,
              ),
  ...
  Future<void> onayla(
    ...
    try {
      ...
      if (context.mounted) {
        mesaj(
          context,
          'Talep onaylandı. İlan öne çıkarıldı.',
        );
      }
    } catch (_) {
      if (context.mounted) {
